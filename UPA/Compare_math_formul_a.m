...
% 天线数量
antenna_num_x = 10 : 1 : 30;
antenna_num_y = 10 : 1 : 30;
hpbw_theta_phi_math=zeros(1, length(antenna_num_x)); %波束宽度矩阵
...
for i = 1:length(antenna_num_x)
    ...
    hpbw_theta_phi_math(i)=math_hpbw(antenna_num_x(i),antenna_num_y(i),Gain,tolerance,Delta);%math_hpbw是求解波束宽度函数
...
plot(antenna_num_x,hpbw_theta_phi_math);hold on;
